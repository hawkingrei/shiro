...
Latest sync: pinned React version in ESLint settings and bumped CI Node to 20.19.0 for ESLint 10 compatibility (2026-02-10).
Latest sync: switched Next base lint parser to TypeScript to avoid ESLint 10 scope manager incompatibilities (2026-02-10).
