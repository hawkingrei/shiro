...
7. Add a post-`InitWithOptions` Impo scope-validation pass so stage1 rewrites that change alias or merged-column visibility are filtered before `impo:base_exec_failed`.
