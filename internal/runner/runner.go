...
type Runner struct {
	...
	genSQLSetOperations      int64
	genSQLDerivedTables      int64
	genSQLQuantifiedSubquery int64
	genSQLWindow             int64
	genSQLWindowFrame        int64
	...
	impoMutationCounts              map[string]int64
	impoMutationExecCounts          map[string]int64
	...
	templateJoinPredicateStrategies map[string]int64
	viewQueries                     int64
	viewTableRefs                   int64
