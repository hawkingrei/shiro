...
If you need readiness gating, set `oracles.mpp_tiflash_wait_seconds` to a positive value so Shiro polls `information_schema.tiflash_replica` until `AVAILABLE=1` (or timeout).
