...
EET also applies a unified table-factor budget via `oracles.eet_complexity_join_tables_threshold` (default `4`), counting main query table factors plus CTE definitions and CTE-body table factors.
...
oracles:
  ...
  eet_complexity_join_tables_threshold: 4
  dqp_external_hints:
